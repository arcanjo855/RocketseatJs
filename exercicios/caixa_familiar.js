...
function calcularBalanco(){ // subtrai o valor do array de cima e faz o .log da subtraçao
    const calculoReceita = somar(familia.receita)    // aqui a soma é efetuada
    const calcularDespesas = somar(familia.despesas)

    let total = calculoReceita - calcularDespesas  // subtrai o valor da raceita pelo de gastos
    let itsOk = total >= 0
